	 		...
	 		<div class="horizontal">
				...
				if($custom_theme == 'custom'){
					if( get_option('mo_openid_facebook_share_enable') ) {
                        ...
                        ?>
						<a rel='nofollow' title="Facebook" onclick="popupCenter('<?php echo $link; ?>', 800, 400);" class="mo-openid-share-link" style=""><i class="mo-custom-share-icon <?php echo $selected_theme; ?> mofa mofa-facebook" style="padding-top:8px;text-align:center;color:#ffffff;font-size:<?php echo ($sharingSize-16); ?>px !important;background-color:#<?php echo $custom_color?>;height:<?php echo $sharingSize; ?>px !important;width:<?php echo $sharingSize; ?>px !important"></i></a>
						<?php
					}
					...
					if( get_option('mo_openid_facebook_share_enable') ) {
                        $link = esc_url('https://www.facebook.com/sharer/sharer.php?u='.$url.'&src=sdkpreparse');
                        ?>
						<a rel='nofollow' title="Facebook" onclick="popupCenter('<?php echo $link; ?>', 800, 400);" class="mo-openid-share-link" style=""><i class=" <?php echo $selected_theme; ?> mofa mofa-facebook" style="padding-top:4px;text-align:center;color:#<?php echo $fontColor ?> !important;font-size:<?php echo $sharingSize; ?>px !important;height:<?php echo $sharingSize; ?>px !important;width:<?php echo $sharingSize; ?>px !important"></i></a>
						<?php
					}
					...
					if( get_option('mo_openid_facebook_share_enable') ) {
                        $link = esc_url('https://www.facebook.com/sharer/sharer.php?u='.$url.'&src=sdkpreparse');
                        ?>
						<a rel='nofollow' title="Facebook" onclick="popupCenter('<?php echo $link; ?>', 800, 400);" class="mo-openid-share-link" style=""><img alt='Facebook' style= 'padding-top:2px; height:<?php echo $sharingSize; ?>px !important;width:<?php echo $sharingSize; ?>px !important;' src="<?php echo plugins_url( 'includes/images/icons/facebook.png', __FILE__ )?>" class="mo-openid-app-share-icons <?php echo $selected_theme; ?>" ></a>
						<?php
					}
